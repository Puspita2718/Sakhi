...
export default function AuthPage({ view, setPage, setUser, language }) {
  ...
  const strings = {
    ...
    heroTitle: { en: 'Empowering your wellness with scientific clinical logs.', hi: 'वैज्ञानिक नैदानिक लॉग के साथ आपके कल्याण को सशक्त बनाना।', bn: 'বৈজ্ঞানিক ক্লিনিকাল লগ দিয়ে আপনার সুস্থতাকে ক্ষমতায়ন করা।', ta: 'அறிவியல் மருத்துவப் பதிவுகளுடன் உங்கள் ஆரோக்கியத்தை மேம்படுத்துதல்.', te: 'శాస్త్రీయ క్లినికల్ లాగ్‌లతో మీ వెల్నెస్‌ని శక్తివంతం చేయడం.', mr: 'वैज्ञानिक क्लिनिकल लॉगसह आपले कल्याण सक्षम करणे.' },
    ...
    titles: {
      ...
      forgot: { en: 'Reset Password', hi: 'पासवर्ड रीसेट करें', bn: 'পাসওয়ার্ড রিসেট করুন', ta: 'கடவுச்சொல்லை மீட்டமை', te: 'పాస్‌వర్డ్‌ని రీసెట్ చేయండి', mr: 'पासवर्ड रीसेट करा' }
    },
    subtitles: {
    ...
    forgotBtn: { en: 'Forgot Password?', hi: 'पासवर्ड भूल गए?', bn: 'পাসওয়ার্ড ভুলে গেছেন?', ta: 'கடவுச்சொல்லை மறந்துவிட்டீர்களா?', te: 'పాస్‌వర్డ్ మర్చిపోయారా?', mr: 'पासवर्ड विसरलात?' },
    ...
    orAuth: { en: 'or authenticate with', hi: 'या इसके साथ प्रमाणित करें', bn: 'অথবা দিয়ে প্রমাণীকরণ করুন', ta: 'அல்லது அங்கீகரிக்கவும்', te: 'లేదా ప్రామాణీకరించండి', mr: 'किंवा यासह प्रमाणित करा' },
          ...
          {view === 'forgot' ? (
            <form onSubmit={() => alert('Verification reset link queued. Check your inbox.')} className="flex flex-col gap-4 text-xs">
              ...
              <button type="submit" className="rounded-full bg-feminine-pink hover:bg-feminine-pink/90 text-white py-3.5 font-bold shadow-lg shadow-pink-500/20 transition-all duration-300 cursor-pointer">
                {strings.sendReset[language] || strings.sendReset['en']}
              </button>
            ...
            <form onSubmit={handleLogin} className="flex flex-col gap-4 text-xs">
              ...
              <button type="submit" onClick={handleLogin} className="rounded-full bg-gradient-to-r from-feminine-pink to-feminine-purple py-3.5 font-bold text-white shadow-xl shadow-pink-500/20 active:scale-98 transition-all duration-300 cursor-pointer">
                {view === 'login' ? (strings.authBtn[language] || strings.authBtn['en']) : (strings.regBtn[language] || strings.regBtn['en'])}
              </button>
